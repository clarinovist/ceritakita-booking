...
## [1.3.0](https://github.com/clarinovist/ceritakita-booking/compare/v1.2.0...v1.3.0) (2026-09-15)
...
* **attribution:** auto-link bookings→leads by phone + leads→campaigns via utm + backfill endpoint + cron chain ([7844912](https://github.com/clarinovist/ceritakita-booking/commit/7844912faedfdbcd49c8a39692b650cb65d14367))
...
* **booking:** enable promo codes and safe package changes ([e689d10](https://github.com/clarinovist/ceritakita-booking/commit/e689d10c452a373781eeaa65cde858f9bb51d7f6))
...
* **debug:** add debug attribution endpoint to inspect bookings/leads matching ([0bd9e6d](https://github.com/clarinovist/ceritakita-booking/commit/0bd9e6d9489ed0dab1a9d6ba7d9023eb315e405d))
* **meta-ads:** complete data explorer with granular ingestion, breakdowns, & geographic analytics ([2cce2d8](https://github.com/clarinovist/ceritakita-booking/commit/2cce2d87c926cbacf8eba7c15ab8ba8512139488))
* **meta-ads:** full-funnel optimization - DB as source of truth ([2573e2c](https://github.com/clarinovist/ceritakita-booking/commit/2573e2cea18aff4b9a92955cbdfac7850f892462))
...
* **admin-ads:** align Data Explorer cards styling to light theme admin layout ([5dc8239](https://github.com/clarinovist/ceritakita-booking/commit/5dc8239c0db8fdfb7e5c326fb91e08230db2c642))
* **attribution:** avoid cartesian spend inflation + improve bookings phone match with suffix fallback + lead booking_id update ([21a5d9e](https://github.com/clarinovist/ceritakita-booking/commit/21a5d9ebc46de908a4d8754728087513780436b4))
* **db:** meta tables always-run migration + version bump to 2 - fix VPS no such table meta_sync_log ([7eed5ac](https://github.com/clarinovist/ceritakita-booking/commit/7eed5ac5800e7ff025c1ea818b4ef0e18a3018fd))
* **debug:** move normalizePhone outside handler ([70d950b](https://github.com/clarinovist/ceritakita-booking/commit/70d950b2915f79a5d94d365f8fefe362b0ddbcda))
...
* **health:** probe runtime database instead of cached build response ([bbe023e](https://github.com/clarinovist/ceritakita-booking/commit/bbe023e42bd5009d85c4a95fb4cb90a932b7d568))
* **lint:** remove unused getDb import ([9b4b3c5](https://github.com/clarinovist/ceritakita-booking/commit/9b4b3c585f7701033a07bc158687c801af83b51b))
* **lint:** remove unused recentCamp var ([26cc799](https://github.com/clarinovist/ceritakita-booking/commit/26cc799d69106dc298527908e141627552fcd866))
* **meta:** deduplicate insights with NULL UNIQUE bug + normalize to '' for upsert correctness ([6bc2991](https://github.com/clarinovist/ceritakita-booking/commit/6bc2991f373d6d4cf5891aca5671a59a3368c643))
* **meta:** health endpoint resilient + workflows set+e avoid curl -f exit ([00ad42e](https://github.com/clarinovist/ceritakita-booking/commit/00ad42eefc73634bfe45342b0fe76bcf11c0afc6))
* **ts:** add ! ([43c90c4](https://github.com/clarinovist/ceritakita-booking/commit/43c90c4b0efe35ff6751e7fb07e037aaf6d6bf8c))
* **ts:** downlevelIteration for Map entries + typed l ([1d6cd60](https://github.com/clarinovist/ceritakita-booking/commit/1d6cd60ef320b9f160259b5c9e967e403d09b3f2))
