...
export const metadata: Metadata = {
  title: "Studio Foto Sragen: Panduan Lengkap + Harga 2026 | CeritaKita Studio",
  description:
    "Studio foto terdekat dari Sragen mulai Rp150K. Self photo, wisuda, prewedding, keluarga. CeritaKita Studio Sukoharjo — cuma 35 menit dari Sragen!",
  keywords:
    "studio foto sragen, foto studio sragen, studio foto murah sragen, self photo sragen, foto wisuda sragen, foto prewedding sragen, fotografer sragen",
  openGraph: {
    title: "Studio Foto Sragen — CeritaKita Studio",
    description:
      "Studio foto profesional dekat Sragen mulai Rp150K. Termasuk makeup, kostum adat Jawa, dan editing profesional. Booking sekarang!",
    url: "https://ceritakitastudio.site/blog/studio-foto-sragen",
    siteName: "CeritaKita Studio",
    locale: "id_ID",
    type: "article",
  },
  alternates: {
    canonical: "https://ceritakitastudio.site/blog/studio-foto-sragen",
  },
};

export default function StudioFotoSragenPage() {
  return (
    <main className="bg-olive-900 min-h-screen">
      <JsonLd data={{
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Dimana studio foto terdekat dari Sragen?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "CeritaKita Studio berlokasi di Sukoharjo, hanya 35 menit dari pusat Sragen via jalan utama. Akses mudah dan parkir luas."
            }
          },
          {
            "@type": "Question",
            "name": "Berapa harga studio foto di dekat Sragen?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Apakah bisa booking studio foto dari Sragen?",
            "acceptedAnswer": {
              "@type": "Answer",
      ...
      <JsonLd data={{
        "@context": "https://schema.org",
        "@type": "Product",
        "name": "Studio Foto Sragen",
        "description": "Sesi foto studio di CeritaKita Studio Sukoharjo, dekat Sragen. Termasuk makeup, kostum, sesi foto 30 menit, dan editing profesional.",
      ...
      <article className="max-w-4xl mx-auto px-6 py-20 text-cream-100">
        <nav className="text-sm text-cream-400 mb-8">
          ...
          <span>Studio Foto Sragen</span>
        </nav>

        <h1 className="font-display text-4xl md:text-5xl tracking-wide mb-6">
          Studio Foto di Sragen: Panduan Lengkap + Harga 2026
        </h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-cream-200 leading-relaxed">
          <p>
            Cari <strong>studio foto terbaik di Sragen</strong>? Kamu nggak perlu jauh-jauh ke Solo! CeritaKita Studio di Sukoharjo cuma <strong>35 menit dari pusat Sragen</strong> — dekat, mudah dijangkau, dan harga sangat terjangkau. Mulai dari Rp40 ribu untuk pas foto hingga paket wedding premium, kami siap memenuhi kebutuhan fotografi kamu.
          </p>

          <h2 className="font-display text-2xl text-gold-400 mt-12">
            Kenapa Pilih CeritaKita Studio untuk Warga Sragen?
          </h2>

          <ul className="list-disc list-inside space-y-3 text-cream-300">
            <li><strong>Jarak dekat</strong> — Cuma 35 menit dari Sragen via jalan utama</li>
          ...
          <div className="bg-olive-800 border border-gold-400/30 p-6 rounded-lg mt-12">
            ...
            <p className="text-cream-300 mb-4">
              Mau foto dari Sragen? Langsung chat kami! Harga mulai Rp150K sudah termasuk makeup dan kostum adat Jawa. Jadwal terbatas, booking sekarang!
            </p>
            <a
              href="https://wa.me/6285190832058?text=Halo%20CeritaKita%2C%20saya%20dari%20Sragen%20mau%20booking%20sesi%20foto"
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-cream-100">Dimana studio foto terdekat dari Sragen?</h3>
              <p className="text-cream-300">CeritaKita Studio berlokasi di Sukoharjo, hanya 35 menit dari pusat Sragen via jalan utama. Akses mudah dan parkir luas.</p>
            </div>
            <div>
              <h3 className="font-bold text-cream-100">Berapa harga studio foto di dekat Sragen?</h3>
            ...
            <div>
              <h3 className="font-bold text-cream-100">Apakah bisa booking studio foto dari Sragen?</h3>
