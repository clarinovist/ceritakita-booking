...
export const metadata: Metadata = {
  title: "Studio Foto Klaten: Panduan Lengkap + Harga 2026 | CeritaKita Studio",
  description:
    "Studio foto terbaik dekat Klaten mulai Rp150K. Include makeup, kostum, sesi foto profesional. Booking CeritaKita Studio Sukoharjo — cuma 25 menit dari Klaten!",
  keywords:
    "studio foto klaten, foto studio klaten, studio foto murah klaten, self photo klaten, foto wisuda klaten, foto prewedding klaten, fotografer klaten",
  openGraph: {
    title: "Studio Foto Klaten — CeritaKita Studio",
    description:
      "Studio foto profesional dekat Klaten mulai Rp150K. Termasuk makeup, kostum adat Jawa, dan editing profesional. Booking sekarang!",
    url: "https://ceritakitastudio.site/blog/studio-foto-klaten",
    siteName: "CeritaKita Studio",
    locale: "id_ID",
    type: "article",
  },
  alternates: {
    canonical: "https://ceritakitastudio.site/blog/studio-foto-klaten",
  },
};

export default function StudioFotoKlatenPage() {
  return (
    <main className="bg-olive-900 min-h-screen">
      <JsonLd data={{
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Dimana studio foto terdekat dari Klaten?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "CeritaKita Studio berlokasi di Sukoharjo, hanya 25 menit dari pusat Klaten via Jalan Raya Solo-Yogyakarta. Akses mudah dan parkir luas."
            }
          },
          {
            "@type": "Question",
            "name": "Berapa harga studio foto di dekat Klaten?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Apakah bisa booking studio foto dari Klaten?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Bisa! Booking sangat mudah via WhatsApp. Banyak customer dari Klaten yang sudah membuktikan kualitas layanan CeritaKita Studio."
            }
          },
          {
            "@type": "Question",
      ...
      <JsonLd data={{
        "@context": "https://schema.org",
        "@type": "Product",
        "name": "Studio Foto Klaten",
        "description": "Sesi foto studio di CeritaKita Studio Sukoharjo, dekat Klaten. Termasuk makeup, kostum, sesi foto 30 menit, dan editing profesional.",
      ...
      <article className="max-w-4xl mx-auto px-6 py-20 text-cream-100">
        <nav className="text-sm text-cream-400 mb-8">
          ...
          <span>Studio Foto Klaten</span>
        </nav>

        <h1 className="font-display text-4xl md:text-5xl tracking-wide mb-6">
          Studio Foto di Klaten: Panduan Lengkap + Harga 2026
        </h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-cream-200 leading-relaxed">
          <p>
            Cari <strong>studio foto terbaik di Klaten</strong>? Kamu nggak perlu jauh-jauh ke Solo! CeritaKita Studio di Sukoharjo cuma <strong>25 menit dari pusat Klaten</strong> — dekat, mudah dijangkau, dan harga sangat terjangkau. Mulai dari Rp40 ribu untuk pas foto hingga paket wedding premium, kami siap memenuhi kebutuhan fotografi kamu.
          </p>

          <h2 className="font-display text-2xl text-gold-400 mt-12">
            Kenapa Pilih CeritaKita Studio untuk Warga Klaten?
          </h2>
          ...
          <div className="bg-olive-800 border border-gold-400/30 p-6 rounded-lg mt-12">
            ...
            <p className="text-cream-300 mb-4">
              Mau foto dari Klaten? Langsung chat kami! Harga mulai Rp150K sudah termasuk makeup dan kostum adat Jawa. Jadwal terbatas, booking sekarang!
            </p>
            <a
              href="https://wa.me/6285190832058?text=Halo%20CeritaKita%2C%20saya%20dari%20Klaten%20mau%20booking%20sesi%20foto"
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-cream-100">Dimana studio foto terdekat dari Klaten?</h3>
              <p className="text-cream-300">CeritaKita Studio berlokasi di Sukoharjo, hanya 25 menit dari pusat Klaten via Jalan Raya Solo-Yogyakarta. Akses mudah dan parkir luas.</p>
            </div>
            <div>
              <h3 className="font-bold text-cream-100">Berapa harga studio foto di dekat Klaten?</h3>
            ...
            <div>
              <h3 className="font-bold text-cream-100">Apakah bisa booking studio foto dari Klaten?</h3>
              <p className="text-cream-300">Bisa! Booking sangat mudah via WhatsApp. Banyak customer dari Klaten yang sudah membuktikan kualitas layanan CeritaKita Studio.</p>
            </div>
            <div>
