...
export const metadata: Metadata = {
  title: "Studio Foto Karanganyar: Panduan Lengkap + Harga 2026 | CeritaKita Studio",
  description:
    "Studio foto terdekat dari Karanganyar mulai Rp150K. Self photo, wisuda, prewedding, keluarga. CeritaKita Studio Sukoharjo — cuma 20 menit dari Karanganyar!",
  keywords:
    "studio foto karanganyar, foto studio karanganyar, studio foto murah karanganyar, self photo karanganyar, foto wisuda karanganyar, foto prewedding karanganyar, fotografer karanganyar",
  openGraph: {
    title: "Studio Foto Karanganyar — CeritaKita Studio",
    description:
      "Studio foto profesional dekat Karanganyar mulai Rp150K. Termasuk makeup, kostum adat Jawa, dan editing profesional. Booking sekarang!",
    url: "https://ceritakitastudio.site/blog/studio-foto-karanganyar",
    siteName: "CeritaKita Studio",
    locale: "id_ID",
    type: "article",
  },
  alternates: {
    canonical: "https://ceritakitastudio.site/blog/studio-foto-karanganyar",
  },
};

export default function StudioFotoKaranganyarPage() {
  return (
    <main className="bg-olive-900 min-h-screen">
      <JsonLd data={{
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Dimana studio foto terdekat dari Karanganyar?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "CeritaKita Studio berlokasi di Sukoharjo, hanya 20 menit dari pusat Karanganyar via Jalan Raya Solo-Karanganyar. Akses mudah dan parkir luas."
            }
          },
          {
            "@type": "Question",
            "name": "Berapa harga studio foto di dekat Karanganyar?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Apakah bisa booking studio foto dari Karanganyar?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Bisa! Booking sangat mudah via WhatsApp. Banyak customer dari Karanganyar yang sudah membuktikan kualitas layanan CeritaKita Studio."
            }
          },
          {
            "@type": "Question",
            "name": "Jenis foto apa saja yang tersedia di studio dekat Karanganyar?",
            "acceptedAnswer": {
              "@type": "Answer",
      ...
      <JsonLd data={{
        "@context": "https://schema.org",
        "@type": "Product",
        "name": "Studio Foto Karanganyar",
        "description": "Sesi foto studio di CeritaKita Studio Sukoharjo, dekat Karanganyar. Termasuk makeup, kostum, sesi foto 30 menit, dan editing profesional.",
      ...
      <JsonLd data={{
        "@context": "https://schema.org",
        "@type": "Product",
        "name": "Foto Keluarga Karanganyar",
      ...
      <article className="max-w-4xl mx-auto px-6 py-20 text-cream-100">
        <nav className="text-sm text-cream-400 mb-8">
          ...
          <span>Studio Foto Karanganyar</span>
        </nav>

        <h1 className="font-display text-4xl md:text-5xl tracking-wide mb-6">
          Studio Foto di Karanganyar: Panduan Lengkap + Harga 2026
        </h1>

        <p className="text-cream-300 text-sm mb-8">
          Terakhir diperbarui: 14 Juli 2026 · Waktu baca: 5 menit
        </p>

        <div className="prose prose-invert max-w-none space-y-6 text-cream-200 leading-relaxed">
          <p>
            Cari <strong>studio foto terbaik di Karanganyar</strong>? Kamu nggak perlu jauh-jauh ke Solo! CeritaKita Studio di Sukoharjo cuma <strong>20 menit dari pusat Karanganyar</strong> — dekat, mudah dijangkau, dan harga sangat terjangkau. Mulai dari Rp40 ribu untuk pas foto hingga paket wedding premium, kami siap memenuhi kebutuhan fotografi kamu.
          </p>

          <h2 className="font-display text-2xl text-gold-400 mt-12">
            Kenapa Pilih CeritaKita Studio untuk Warga Karanganyar?
          </h2>

          <ul className="list-disc list-inside space-y-3 text-cream-300">
            <li><strong>Jarak dekat</strong> — Cuma 20 menit dari Karanganyar via Jalan Raya Solo-Karanganyar</li>
            ...
            <li><strong>Parkir luas</strong> dan akses mudah dari arah Karanganyar</li>
          </ul>
          ...
          <div className="bg-olive-800 border border-gold-400/30 p-6 rounded-lg mt-12">
            ...
            <p className="text-cream-300 mb-4">
              Mau foto dari Karanganyar? Langsung chat kami! Harga mulai Rp150K sudah termasuk makeup dan kostum adat Jawa. Jadwal terbatas, booking sekarang!
            </p>
            <a
              href="https://wa.me/6285190832058?text=Halo%20CeritaKita%2C%20saya%20dari%20Karanganyar%20mau%20booking%20sesi%20foto"
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-cream-100">Dimana studio foto terdekat dari Karanganyar?</h3>
              <p className="text-cream-300">CeritaKita Studio berlokasi di Sukoharjo, hanya 20 menit dari pusat Karanganyar via Jalan Raya Solo-Karanganyar. Akses mudah dan parkir luas.</p>
            </div>
            <div>
              <h3 className="font-bold text-cream-100">Berapa harga studio foto di dekat Karanganyar?</h3>
            ...
            <div>
              <h3 className="font-bold text-cream-100">Apakah bisa booking studio foto dari Karanganyar?</h3>
              <p className="text-cream-300">Bisa! Booking sangat mudah via WhatsApp. Banyak customer dari Karanganyar yang sudah membuktikan kualitas layanan CeritaKita Studio.</p>
            </div>
            <div>
              <h3 className="font-bold text-cream-100">Jenis foto apa saja yang tersedia di studio dekat Karanganyar?</h3>
