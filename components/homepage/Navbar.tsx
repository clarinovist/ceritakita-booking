...
export function Navbar() {
    ...
    return (
        <nav
            className={`sticky top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'bg-olive-900/95 backdrop-blur-sm py-4 shadow-md' : 'bg-olive-900 md:bg-transparent py-4 md:py-6'
                }`}
        >
