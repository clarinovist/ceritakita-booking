        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {sortedSummary.slice(0, 6).map(([type, val]) => {
              ...
              return (
                <div key={type} className="bg-gray-50 p-4 rounded-xl space-y-1.5 border border-gray-100">
                  <div className="flex justify-between text-xs font-bold">
                    <span className="text-gray-900 truncate max-w-[240px]" title={type}>{type}</span>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border rounded-xl text-xs bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 w-48"
            />
          </div>
              ...
              <tbody className="divide-y font-mono">
                {filteredActions.map((act) => (
                  <tr key={act.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-3 font-bold text-gray-900">{Number(act.value || 0).toLocaleString()}</td>
